    ...
    <div class="row justify-content-center">
      <div class="col-xl-5 col-lg-6 col-md-4">
        <div class="p-5">
          ...
          <hr>
          <h3>Daftar</h3>
          <form class="user" action="proses-daftar.php" method="post">
            ...
            <div class="form-group">
              <span class="desc">Nama</span>
              <input type="text" name="nama" class="form-control form-control-user" id="exampleInputName" placeholder="Your Name" style="border-radius: 8px; ">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="password" name="confirmPass" class="form-control form-control-user" id="exampleConPassword" placeholder=" Confirm Your Password" style="border-radius: 8px;">
            </div>
            <input type="submit" name="submit" class="btn btn-success btn-user btn-block" value="Daftar">
          </form>
        </div>
      </div>
    </div>
